...
public class CalcController {
	...
	// 1. JSP 파일업로드, 날짜, ... => Spring을 사용한다고 거르기 X, 그대로 사용
	//	요청파라미터 : String => 필요하다면 형변환해서 사용
...
//	}
	...
	// 2. Spring 스타일(한글 넣으면 안나옴 ㅎ_ㅎ)
//	@RequestMapping(value = "calculate.do", method = RequestMethod.POST)
//	@RequestMapping(value = 임의지정( form의 action값), method = RequestMethod.POST)
//	public String	calcXY(
//			@RequestParam(value="n") String n,
//			@RequestParam(value="x") int x,
//			@RequestParam(value="y") int y) { // 밸류값에는 요청파라미터 명
