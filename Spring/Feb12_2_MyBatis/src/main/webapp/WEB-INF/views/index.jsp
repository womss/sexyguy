...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%> <!-- jsp에서 날짜형식이 db에서 가져오는것이다 보니 너무길고 맘에 안들기 때문에 jstl의 포맷팅을 가지고 옴 -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<hr>
	<c:forEach var="t" items="${tests }"> <!-- t 안에 들어있는 멤버변수 불러와서 -->
		${t.s_subject } - 
		<fmt:formatDate value="${t.s_date }" type="date" dateStyle="long"/> <p>
	</c:forEach>
	${r }
</body>
</html>